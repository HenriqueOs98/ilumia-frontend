...
- **Controles Interativos:** É possível ligar ou desligar a visualização de cada fonte de energia clicando nos seletores acima do gráfico.
...
- **Se a pergunta contém `reserva estratégica` ou `nível da reserva`:**
  - **Resposta:** *"O nível da reserva estratégica está em 68.5%, considerado um nível seguro e adequado para o período, garantindo a estabilidade do sistema."*

Se a pergunta não corresponder a nenhum comando ou pergunta pré-definida, o assistente fornecerá uma resposta genérica com base no contexto selecionado (Dados Gerais, Itaipu, etc.).